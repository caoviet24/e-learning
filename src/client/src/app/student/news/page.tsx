...
const newsItems = [
    ...
    },
    {
        ...
        description:
            'Trường thông báo lịch nghỉ lễ Giỗ tổ Hùng Vương năm 2024 cho toàn thể cán bộ, giảng viên và sinh viên...',
        date: '2024-03-15',
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {newsItems.map((news) => (
                    <Card key={news.id} className="hover:shadow-lg transition-shadow overflow-hidden">
                        ...
                        <CardFooter>
                            <p className="text-sm text-muted-foreground">Người đăng: {news.author}</p>
                        </CardFooter>
                    </Card>
                ))}
            </div>
