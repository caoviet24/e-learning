...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250418171705_UpdateDb9")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.Class", b =>
                {
                    ...
                    b.Property<string>("TeachScheduleId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entites.TeachSchedule", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("numOfPeriods")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entites.Class", b =>
                {
                    b.HasOne("Domain.Entites.TeachSchedule", null)
                        .WithMany("Classes")
                        .HasForeignKey("TeachScheduleId");
            ...
            modelBuilder.Entity("Domain.Entites.TeachSchedule", b =>
                {
                    ...
                    b.HasOne("Domain.Entites.User", "createdUser")
                        .WithMany("CreatedTeachSchedulesUser")
                        .HasForeignKey("createdBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entites.User", "Lecturer")
                        .WithMany("TeachSchedulesUser")
            ...
            modelBuilder.Entity("Domain.Entites.User", b =>
                {
                    ...
                    b.Navigation("CreatedTeachSchedulesUser");
                    ...
                    b.Navigation("TeachSchedulesUser");
