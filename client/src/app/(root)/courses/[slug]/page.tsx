          ...
          <div className="md:col-span-2 p-0">
            ...
            <div className="p-6">
              ...
              <div className="prose dark:prose-invert max-w-none">
                <p>
                  Đây là nội dung chi tiết của bài học. Bao gồm các kiến thức lý thuyết,
            ...
            <div className="p-6 border-b dark:border-gray-700">
              ...
              <div className="space-y-2">
                {[1, 2, 3, 4, 5].map((lesson) => (
                  <div
                    key={lesson}
                    className={`p-3 rounded ${lesson === 1 ? 'bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500' : 'hover:bg-gray-50 dark:hover:bg-gray-800'}`}
                  >
